...
contract WeRent is WerentSignature, IWeRent, ERC721Holder, ERC1155Receiver, ERC1155Holder, Initializable {
    ...
    function lend(
        ...
        bytes32[] memory _categories // New parameter for categories
    ) external override notPaused notBlacklisted {
        // Ensure the categories array is the correct length
        require(_nfts.length == _categories.length, "Mismatched categories length");
